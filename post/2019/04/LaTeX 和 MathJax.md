...
LaTeX 是一种基于 TeX 的排版系统，每一个 LaTeX 命令实际上最后都会被转换解释成几个甚至上百个 TeX 命令。而 TeX 由高德纳 ( Donald Knuth ) 发明并创造，他最早开始自行编写 TeX 的原因，是因为当时的计算机排版技术十分粗糙，已经影响到他的巨著《计算机程序设计艺术》的印刷质量。他以典型的黑客思维模式，决定自行编写一个排版软件，其后花费十年编写完成。
